<template>
    <div>
        ...
        <div id="form-search" class="text-white py-5">
            ...
            <div class="container">
                <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12">
                    ...
                    <p>
                        Lacak transaksi kamu dengan cara memasukkan Nomor
                        Invoice dibawah ini:
                    </p>
                </div>
            </div>
        ...
        <div class="container mx-auto bg-dark pt-5 text-white">
            <div class="row">
                <div class="col">
                    <h2>TOP-UP IN</h2>
                    <p>
                        Jl. Ring Road Utara, Ngringin, Condongcatur, Kecamatan
                        Depok, Kabupaten Sleman, Daerah Istimewa Yogyakarta
                    </p>
                    <p>
                        Email: info@topupin.com<br />
                        Telepon: +62008953646
                    </p>
                ...
                <div class="col">
                    ...
                    <p>
                        Jika Anda memiliki masalah atau pertanyaan, jangan ragu
                        untuk menghubungi kami dengan mengisi formulir di bawah
                        ini.
                    </p>
            ...
            <svg
                ...
                class="-mt-8 transition delay-150 duration-300 ease-in-out print:hidden md:-mt-24 col-sm-12"
            >
                <path
