<template>
  <div>
    ...
    <div id="form-search" class="text-white pt-5">
      <ul class="circles">
        <li></li>
        <li></li>
        <li></li>
      ...
      <svg
        ...
        class="-mt-8 transition delay-150 duration-300 ease-in-out print:hidden md:-mt-24 mt-5 pt-5"
      >
        <path
  ...
  methods: {
    cekTransaksi() {
      if (!this.order_id) {
        return Swal.fire({
          title: "Error!",
          text: "Isi Nomor Invoice kamu yang seperti TOPUPIN-xxxx",
          icon: "error",
          toast: true,
          position: "top-end",
